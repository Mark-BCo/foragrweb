...
const Partners = () => {
    ...
    return (
        <>
            ...
            <div id="section-1" className='flex flex-wrap justify-between min-h-screen antialiased font-black'>
                <div className='m-10 border rounded overflow-hidden shadow-lg grid place-content-center hover:bg-cugreen transition ease-in duration-300 hover:text-white hover:shadow-lg'>
